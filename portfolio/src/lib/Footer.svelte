<script>
	let headings = [
    //Employer's Website
		{url: 'https://www.fastfetch.biz/', name: 'FastFetch'}, 
    //LinkedIn 
    {url: 'https://www.linkedin.com/in/brandon-wingard-4886b7148/', name: 'LinkedIn'},
	]

</script>


<footer class="footer footer-center p-10 bg-primary text-primary-content  min-w-full">
  <div>
    ...
    <p class="font-bold">
      Brandon Wingard <br>Delivering Dependable Solutions since 2022
    </p> 
  ...
  <div>
    ...
    <p> powered by Svelte, DaisyUI, and TailwindCSS</p>
  </div>
</footer>